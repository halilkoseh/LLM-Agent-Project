...
<head>
    ...
    <title>Register - LLM Agents Platform</title>
        ...
        <div class="p-8 lg:w-1/2 lg:p-12">
            <div class="flex flex-col h-full max-w-md mx-auto">
                ...
                <div class="mb-8 text-center">
                    ...
                    <h2 class="mb-2 text-3xl font-bold text-gray-800">Create Account</h2>
                    <p class="text-sm text-gray-600">Join the LLM Agents Platform to access AI-powered development tools</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" placeholder="Your full name" class="block w-full p-3 pl-10 border border-gray-300 rounded-lg focus:ring-primary-600 focus:border-primary-600">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <input id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="username" placeholder="you@example.com" class="block w-full p-3 pl-10 border border-gray-300 rounded-lg focus:ring-primary-600 focus:border-primary-600">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <input id="password" type="password" name="password" required autocomplete="new-password" placeholder="••••••••" class="block w-full p-3 pl-10 border border-gray-300 rounded-lg focus:ring-primary-600 focus:border-primary-600">
                    ...
                    <div>
                        ...
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="••••••••" class="block w-full p-3 pl-10 border border-gray-300 rounded-lg focus:ring-primary-600 focus:border-primary-600">
                        </div>
                    ...
                    <div class="flex flex-col pt-4 space-y-3">
                        ...
                        <div class="text-center">
                            <a class="text-sm font-medium text-primary-600 hover:text-primary-500" href="{{ route('login') }}">
